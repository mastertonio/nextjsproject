          ...
          {preview ? (
            ...
            <div>
              <Text align="center" weight={700} size="lg" mt="xl">
                ...
                <Dropzone.Reject>
                  Gifs file less than 30mb
                </Dropzone.Reject>
                <Dropzone.Idle>Upload Gifs</Dropzone.Idle>
              </Text>
              <Text align="center" size="sm" mt="xs" color="dimmed">
                Drag&apos;n&apos;drop files here to upload. We can accept only{" "}
                <i>.gif</i> files that are less than 30mb in size.
              </Text>
            </div>
          )}
        </div>
