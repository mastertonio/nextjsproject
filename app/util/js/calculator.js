          ...
          if(visibility){
              ...
              $.each(visibility, function(){
                  var operator = this.operator ? this.operator : '==',
                      evaluator = ( typeof parent.value == "string" ? '"' + parent.value + '"' : parent.value || 0 ) + operator + this.value;
