...
const ElementInput: React.FC<iGrayProps> = ({
    type,
    classes,
    elements,
}) => {
                ...
                <form onBlur={
                    ...
                    {elements.map((elem) => (
                        <div key={elem._id}>
                            ...
                            <Stack>
                                {elements.length > 0 ? elements.map((state) => (
                                    <Grid
                                        key={state._id}
                                    ...
                                    >
                                        ...
                                        {state.dataType == "textarea" ? (
                                            ...
                                            />) : state.dataType == "ratings" ? (
                                                ...
                                                />) : state.dataType == "inputB" ? (
                                                    <div className="flex items-center ml-auto remove-radius" key={state._id}>
                                                        <NumberInput
